...
## Script & API
 ...
 - Input: Interface into the Input system. For detailed API of Input, click [here](https://docs.unity3d.com/ScriptReference/Input.html).
 ...
 - KeyCode: Key codes that map to physical key, including keyboard, mouse and joystick. For detailed API of KeyCode, click [here](https://docs.unity3d.com/ScriptReference/KeyCode.html).
 - Time: The interface to get time information. For detailed API of Time, click [here](https://docs.unity3d.com/ScriptReference/Time.html).
